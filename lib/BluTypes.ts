...
export interface BluProviderMeta {
  ...
  status: 'verified' | 'implemented' | 'limited' | 'planned' | 'unsupported';
...
export interface BluTelemetry {
  ...
  /** Human-readable provider/device status */
  status_text?: string;
  /** Diagnostics or warning labels from the provider */
  diagnostics?: string[];
  /** Alert labels from the provider */
  alerts?: string[];
