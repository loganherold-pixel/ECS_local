...
export const DASHBOARD_WIDGET_CATALOG: readonly DashboardCatalogEntry[] = [
  ...
  },
  {
    ...
    purpose: 'A wide navigation command card for monitoring live route guidance, GPS state, and staged-route context from Dashboard.',
    recommendedSize: 'standard',
    recommendedWidgetSize: '2x1',
    supportedWidgetSizes: ['2x1'],
    minimumWidgetSize: '2x1',
    ...
    supportedModes: ['expedition', 'highway'],
    liveData: true,
    liveSources: ['route state', 'gps', 'navigation context'],
    defaultModes: [],
    isDefaultSelectable: true,
...
export const WIDGET_REGISTRY: WidgetRegistryEntry[] = [
...

  {
    ...
    description: 'Wide dashboard navigation command card with staged-route visibility',
    ...
    supports_advanced: false,
    supports_modes: ['expedition', 'highway'],
    data_provides: ['route_state', 'destination', 'navigation_context', 'gps_position'],
    render_ready: true,
    widget_status: 'active',
  },
