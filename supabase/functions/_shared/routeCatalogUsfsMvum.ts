...
export const USFS_MVUM_PILOT_FORESTS: UsfsMvumForest[] = [
  ...
  },
  {
    ...
    sourceProviderId: 'usfs_mvum_beaverhead_deerlodge_nf',
    sourceName: 'USFS MVUM - Beaverhead-Deerlodge National Forest',
    sourceUri: 'https://www.fs.usda.gov/r01/beaverhead-deerlodge/maps-guides',
    currentConditionProviderId: 'usfs_current_conditions_beaverhead_deerlodge_nf',
    currentConditionSourceName: 'USFS Alerts and Current Conditions - Beaverhead-Deerlodge National Forest',
    currentConditionSourceUri: 'https://www.fs.usda.gov/r01/beaverhead-deerlodge/alerts',
    currentConditionReferenceUri: 'https://www.fs.usda.gov/r01/beaverhead-deerlodge/conditions',
  },
  {
    slug: 'chugach-national-forest',
    forestName: 'Chugach National Forest',
    sourceProviderId: 'usfs_mvum_chugach_nf',
    sourceName: 'USFS MVUM - Chugach National Forest',
    sourceUri: 'https://www.fs.usda.gov/r10/chugach/maps-guides',
    currentConditionProviderId: 'usfs_current_conditions_chugach_nf',
    currentConditionSourceName: 'USFS Alerts and Current Conditions - Chugach National Forest',
    currentConditionSourceUri: 'https://www.fs.usda.gov/r10/chugach/alerts',
    currentConditionReferenceUri: 'https://www.fs.usda.gov/r10/chugach/conditions',
  },
  {
    slug: 'custer-gallatin-national-forest',
    forestName: 'Custer Gallatin National Forest',
    sourceProviderId: 'usfs_mvum_custer_gallatin_nf',
    sourceName: 'USFS MVUM - Custer Gallatin National Forest',
    sourceUri: 'https://www.fs.usda.gov/r01/custergallatin/maps-guides',
    currentConditionProviderId: 'usfs_current_conditions_custer_gallatin_nf',
    currentConditionSourceName: 'USFS Alerts and Current Conditions - Custer Gallatin National Forest',
    currentConditionSourceUri: 'https://www.fs.usda.gov/r01/custergallatin/alerts',
    currentConditionReferenceUri: 'https://www.fs.usda.gov/r01/custergallatin/conditions',
  },
  {
    slug: 'gallatin-national-forest',
    forestName: 'Gallatin National Forest',
    sourceProviderId: 'usfs_mvum_gallatin_nf',
    sourceName: 'USFS MVUM - Gallatin National Forest',
    sourceUri: 'https://www.fs.usda.gov/r01/custergallatin/maps-guides',
    currentConditionProviderId: 'usfs_current_conditions_gallatin_nf',
    currentConditionSourceName: 'USFS Alerts and Current Conditions - Gallatin National Forest',
    currentConditionSourceUri: 'https://www.fs.usda.gov/r01/custergallatin/alerts',
    currentConditionReferenceUri: 'https://www.fs.usda.gov/r01/custergallatin/conditions',
  },
  {
    ...
    sourceProviderId: 'usfs_mvum_modoc_nf',
    sourceName: 'USFS MVUM - Modoc National Forest',
    sourceUri: 'https://www.fs.usda.gov/r05/modoc/maps-guides',
    currentConditionProviderId: 'usfs_current_conditions_modoc_nf',
    currentConditionSourceName: 'USFS Alerts and Current Conditions - Modoc National Forest',
    currentConditionSourceUri: 'https://www.fs.usda.gov/r05/modoc/alerts',
    currentConditionReferenceUri: 'https://www.fs.usda.gov/r05/modoc/conditions',
  },
  {
    slug: 'tongass-national-forest',
    forestName: 'Tongass National Forest',
    sourceProviderId: 'usfs_mvum_tongass_nf',
    sourceName: 'USFS MVUM - Tongass National Forest',
    sourceUri: 'https://www.fs.usda.gov/r10/tongass/maps-guides',
    currentConditionProviderId: 'usfs_current_conditions_tongass_nf',
    currentConditionSourceName: 'USFS Alerts and Current Conditions - Tongass National Forest',
    currentConditionSourceUri: 'https://www.fs.usda.gov/r10/tongass/alerts',
    currentConditionReferenceUri: 'https://www.fs.usda.gov/r10/tongass/conditions',
  },
];
