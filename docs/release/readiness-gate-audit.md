...
- Curated production evidence manifests for Dashboard and Fleet are tracked under narrow `.gitignore` exceptions; raw `.smoke` screenshots, XML, logs, and generated readiness-result files remain ignored local evidence.
