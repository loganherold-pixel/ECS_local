...
| `npm run gate:dashboard-production` | Blocked by remaining Android/widget evidence | Dashboard widget registry, responsive grid, source-labeled widget states, command-center fallback, top-banner brief integration, and Convoy removal from Dashboard checks pass. `.smoke/dashboard-production-evidence.json` backfills existing Android widget visual and live/stale/unavailable source-label evidence, but production remains blocked until command-center switching, phone/landscape rotation, and owner-decision evidence are recorded. |
...
- Dashboard production rollout now has local Android widget visual and live/stale/unavailable source-label evidence backfilled in `.smoke/dashboard-production-evidence.json`; it remains blocked until command-center switching evidence, phone/landscape rotation evidence, and owner-decision evidence are recorded.
