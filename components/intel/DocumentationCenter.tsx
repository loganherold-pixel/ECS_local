    ...
    switch (docId) {
      case 'manifest':
        return [
          ...
          '',
          '  FIELD SYSTEMS:',
          '  - Dashboard Field Utilities: Incident & Recovery, Weather, Quick Note, Comms, Team Ping',
      ...
      case 'field-utilities':
        return [
          ...
          '  - Incident & Recovery: report incidents, safety checklist, ECS assessment, communication packet, timeline, and debrief',
