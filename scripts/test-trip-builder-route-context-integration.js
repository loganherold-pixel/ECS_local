...
assertIncludes(screen, 'routeStart: selectedTrailheadResupplyAnchorCoordinate', 'Trip Builder should search fuel and groceries from the trailhead endpoint, not the approach-route origin.');
