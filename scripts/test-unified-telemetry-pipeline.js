...
has(adapters, 'bluetoothUtilitySensorAdvertisementToEcsTelemetryEvents', 'utility sensor advertisement bridge');
...
has(accessoryManager, 'stopUtilitySensorTelemetryPolling', 'utility sensor live refresh cleanup');
has(adapters, 'identifyBluestackAccessorySensorProfile', 'utility sensor profile resolver');
has(unifiedConnections, 'decodeUtilitySensorLiveTelemetry', 'unified scanner utility sensor advertisement decode');
has(unifiedConnections, 'bluetoothUtilitySensorAdvertisementToEcsTelemetryEvents', 'unified scanner utility sensor advertisement publish');
has(unifiedConnections, 'ecsTelemetryStore.ingestEvents(events)', 'unified scanner utility sensor live telemetry publish');
has(aiContextBuilder, 'ecsTelemetryStore.getUtilitySensorReadings()', 'AI context utility sensor telemetry read');
has(aiContextBuilder, 'getUtilitySensorCurrentFromCapacity', 'AI context live water capacity resolver');
