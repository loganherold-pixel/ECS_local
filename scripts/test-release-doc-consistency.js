...
[
  ...
  'Blocked by moderation/privacy/owner evidence',
  'gate:fleet-production',
  'Passed with Android/profile and regression evidence',
  'gate:dashboard-production',
  'Passed with portrait-lock policy evidence',
  ...
  'Android app-visible offline route start',
  ...
  'Android Trail Pack category/count visual',
  'content review/moderation',
  'Android Fleet profile',
  'scale-ticket confidence',
  '.smoke/dashboard-production-evidence.json',
  'command-center selector evidence',
  'portrait-lock orientation-policy evidence',
