...
assertIncludes(screen, 'Fuel Near Trailhead', 'Trip Builder should label the pre-trailhead fuel picker.');
assertIncludes(screen, 'ECS uses the trailhead as ground zero for pre-trail fuel.', 'Trip Builder should explain the trailhead resupply anchor.');
...
assertIncludes(screen, 'const selectedTrailheadResupplyAnchorCoordinate = selectedRouteStartCoordinate', 'Trip Builder should make trailhead ground zero explicit for smart resupply.');
