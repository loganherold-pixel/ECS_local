...
assertIncludes(screen, 'TRIP_BUILDER_PICKER_MAP_STYLES', 'Trip Builder picker maps should expose compact Day/Satellite style choices.');
assertIncludes(screen, 'testID={`trip-builder-picker-map-style-${style.key}`}', 'Trip Builder picker maps should expose style controls to tests and users.');
assertIncludes(screen, "mapStyle={pickerMapStyle}", 'Trip Builder picker maps should pass the selected map style into MapRenderer.');
