...
assertIncludes(screen, 'SMART_RESUPPLY_SEARCH_RADIUS_TIERS_MILES = [8, 16, 30] as const', 'Trip Builder should search bounded approach-corridor radius tiers before accepting resupply options.');
