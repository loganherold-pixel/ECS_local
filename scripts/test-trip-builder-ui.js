...
assertIncludes(screen, 'liveTrailPackCatalogStore.getSnapshot().trailPacks', 'Trip Builder route selection should include reviewed live catalog routes already loaded by Explore.');
