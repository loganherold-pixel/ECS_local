...
assertIncludes(screen, 'Last Practical Fuel Before Remote Entry', 'Trip Builder should label the operational pre-remote fuel recommendation.');
assertIncludes(screen, 'ECS ranks viable stops along the selected origin-to-trailhead approach.', 'Trip Builder should explain approach-aware resupply ranking.');
...
assertIncludes(screen, 'ECS keeps supplies before the same remote-entry boundary', 'Trip Builder should explain approach-corridor supply sequencing.');
